    ...
    if (platforms && props) {
        ...
        if (isUnixOS()) {
            ...
            windowsPlatforms.forEach(function(winplatform) {
                ...
                if (index > -1) {
                    console.log(`Building of platform '${winplatform}' is not supported in mac and linux`);
...
function __preBuildValidation__(params) {
    ...
    if(appid.length > 16 || appid.length < 4) {
        throw new BuildException(`appid should be between 4 and 16 characters`, 50);
    }
